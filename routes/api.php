...
Route::group(['middleware' => 'api_token', 'prefix' => 'invitaciones'], function () {
    ...
    Route::get('/files/{id}', 'InvitacionController@getFiles');
    Route::post('/file/delete', 'InvitacionController@deleteFile');
    Route::post('/file/add/{id}', 'InvitacionController@addFile');
 ...
 */
 ...
 Route::group(['middleware'=>'api_token','prefix' => 'etapas'], function () {
    ...
    Route::post('/add/{idEvento}', 'EtapaController@addEtapa');
    Route::post('/edit/{etapa}', 'EtapaController@editEtapa');
    Route::delete('/delete/{id}', 'EtapaController@deleteEtapa');
...
Route::group(['middleware'=>'api_token','prefix' => 'menu'], function () {
    ...
    Route::get('/{etapa}', 'MenugEtapasController@getInfo');//
    Route::post('/add/{etapa}', 'MenugEtapasController@agregar');
    Route::post('/edit/{menu}', 'MenugEtapasController@edit');
    // Route::post('/add/{etapa}', 'MenugEtapasController@agregar');
...
//         Route::post('/add', 'MenugEtapasController@agregar');
//         Route::post('/actualizar', 'MenugEtapasController@actualizar');
//         Route::post('/eliminar/{id}', 'MenugEtapasController@eliminar');
//         Route::post('/etapas', 'MenugEtapasController@ajaxDatatables');
//         Route::post('/etapas-add', 'MenugEtapasController@ajaxAdd');
 ...
 */
Route::group(['middleware' => 'api_token', 'prefix' => 'regalos'], function () {
