...
import { cleanHashtags } from './../../redux/actions/social-wall';
...
class SocialWall extends Component {
    ...
    TomarImagen(e){
     ...
     console.log('tomando', this.state.FilesUpload)
      ...
      console.log('correo', this.state.usuario.Correo );
      console.log('_id', this.state.usuario._id);
    ...
    UploadFiles3(){
      ...
      fd.append('email', this.state.usuario.Correo);
      fd.append('id',this.state.usuario._id);
      fd.append('titulo','my album');
  ...
  <div className="modal-dialog" role="document">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick={this.MostrarFoto}>Close</button>
        <button type="button" class="btn btn-primary"   onClick={this.UploadFiles3}>Save changes</button>
      </div>
    </div>
  </div>
</div>
